...
*   [ClawBench](https://github.com/reacher-z/ClawBench) - A reproducible benchmark for web agents with 153 everyday tasks across 144 live websites; the browser-use harness is one of its supported execution backends, and final submission requests are intercepted for safe evaluation.
